...
pkgdatadir = $(datadir)/fprobe-ulog
pkglibdir = $(libdir)/fprobe-ulog
...
CFLAGS = -g -O2 -D_BSD_SOURCE -D_REENTRANT -DWALL -W -Wall
CPP = gcc -E
CPPFLAGS = 
CYGPATH_W = echo
DATE = 2007-10-26
...
target_os = linux-gnu
target_vendor = pc
EXTRA_DIST = autogen.sh fprobe-ulog.spec version \
	contrib/tg.sh contrib/ipt_ULOG.patch
